...
-- Run this file in Supabase SQL Editor after the main LindaStay schema.sql.
-- This file is only for WhatsApp automation tables; it does not replace the main schema.
